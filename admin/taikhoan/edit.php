                ...
                <div class="container-fluid">
                    ...
                    <form action="index.php?act=edittk" method="POST" enctype="multipart/form-data">
                        ...
                        <label for="exampleInputEmail1">User name</label>
                            <input type="text" class="form-control" name="user" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?=$user ?>">
                        </div>

                        <div class="form-group">
                            <label for="exampleInputPassword1">Password</label>
                            <input type="text" class="form-control" name="pass" id="exampleInputPassword1" value="<?=$pass ?>">
                        </div>

                        <div class="form-group">
                            <label for="exampleInputPassword1">Ảnh</label>
                            <input type="file" class="form-control" name="anh" id="exampleInputPassword1" value="<?=$anh ?>">
                        </div>

                        <div class="form-group">
                            <label for="exampleInputPassword1">Sđt</label>
                            <input type="text" class="form-control" name="sdt" id="exampleInputPassword1" value="<?=$sdt ?>">
                        </div>

                        <div class="form-group">
                        <label for="exampleInputEmail1">Email</label>
                            <input type="text" class="form-control" name="email" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?=$email ?>">
                        </div>
